...
def main():
    ...
    ap.add_argument("--wandb_tags", type=str, default="dem,ndsm")
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        if args.use_wandb:
            wandb.log({
                ...
                "train/loss": tr["loss"],
                "train/dem_huber": tr["dem_huber"],
                "train/dem_grad": tr["dem_grad"],
                "train/ndsm_huber": tr["ndsm_huber"],
                "train/ndsm_grad": tr["ndsm_grad"],
                "val/loss": va["loss"],
                "val/dem_huber": va["dem_huber"],
                "val/dem_grad": va["dem_grad"],
                "val/ndsm_huber": va["ndsm_huber"],
                "val/ndsm_grad": va["ndsm_grad"],
            }, step=epoch)
